...
inline void OPTISGui::cb_cameraConnect_i(Fl_Menu_*, void*) {
...
Fl_Menu_Item OPTISGui::menu_MenuBarLEDViewer[] = {
 ...
 {"Reference LED Control", 0,  (Fl_Callback*)OPTISGui::cb_WindowLEDControl2, 0, 17, 0, 0, 14, 56},
 {0},
...
inline void OPTISGui::cb_ZView_i(Fl_Button*, void*) {
  objview->resetView();
oldTransX = 0.0;
oldTransY = 0.0;
oldZoom = 0.0;
...
inline void OPTISGui::cb_LoadMotionOk_i(Fl_Return_Button*, void* v) {
  int i, j, num,ifrag;
  SbVec3d testvec;
  char st[256],ext[256];
  char st2[256];
...
LEDnum = 20;
  { Fl_Double_Window* o = LEDViewer = new Fl_Double_Window(576, 621, "OPTIS");
    ...
    { Fl_Group* o = ControllerBottom = new Fl_Group(0, 591, 577, 30);
      { Fl_Group* o = ControllerBottomLeft = new Fl_Group(0, 591, 499, 30);
        ...
        { Fl_Button* o = XView = new Fl_Button(340, 594, 24, 24, "Y");
          o->callback((Fl_Callback*)cb_XView);
        }
        { Fl_Button* o = YView = new Fl_Button(365, 594, 24, 24, "Z");
          o->callback((Fl_Callback*)cb_YView);
        }
        { Fl_Button* o = ZView = new Fl_Button(390, 594, 24, 24, "X");
  ...
  { Fl_Double_Window* o = TrajectoryWindow = new Fl_Double_Window(390, 286, "Trajectory");
    ...
    { Fl_Group* o = ButtonTPart = new Fl_Group(5, 237, 380, 43);
      o->box(FL_ENGRAVED_FRAME);
      { Fl_Choice* o = RefCoordChoice = new Fl_Choice(25, 255, 25, 25);
        o->down_box(FL_BORDER_BOX);
        o->callback((Fl_Callback*)cb_RefCoordChoice);
      }
  ...
  { Fl_Double_Window* o = MvmNameWindow = new Fl_Double_Window(479, 145, "Name of the next movement");
    ...
    { Fl_Group* o = MvmNameWinGroup = new Fl_Group(5, 5, 470, 135);
      o->box(FL_ENGRAVED_FRAME);
      { Fl_Choice* o = MvmNameListChoice = new Fl_Choice(315, 100, 25, 30, "choice:");
        o->down_box(FL_BORDER_BOX);
...
void OPTISGui::makeDir(char *path, char *name) {
  char     cmd[256];
...
LastStep->value(tmpdata->stopStep+1);
TrajCamSysChoice->value(tmpdata->camSys);
if (((tmpdata->type%1000)>199)&&((tmpdata->type%1000)<218))
   {
      TrajObjChoice->deactivate();
      TrajRefChoice->deactivate();
   }
...
for (csys=0; csys<num; csys++)
{
   for (i=0; i<18; i++)
   {
      if (mainAnimation->led[csys*18+i][mainAnimation->animation_step] != testxyz)
         einfuegen = 1;  // Objekt behalten bzw. einfuegen
      else
         einfuegen = 0;  // Objekt loeschen
      tmplist = objview->objlist;
      while (tmplist != NULL)
      {
...
void OPTISGui::zahlenAnordnen(char *st) {
  int i, j, k, m;
char tst[256];
...
LedCharSpeedFrequency->value(mainAnimation->Speed[camsysnr]-1);
...
for (i=0; i<18; i++)
{
   LEDGroupsBtn[i][mainAnimation->LEDofObject[camsysnr][i]]->setonly();
}
for (i=0; i<6; i++)
{
   ObjGroupsBtn[i][mainAnimation->ObjectsAndReferences[camsysnr][i]+1]->setonly();
}
}
...
mainAnimation->Speed[camsysnr] = LedCharSpeedFrequency->value()+1;
for (i=0; i<18; i++)
{
   j = 0;
